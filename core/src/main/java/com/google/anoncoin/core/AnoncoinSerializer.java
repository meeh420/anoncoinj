...
/**
 * <p>Methods to serialize and de-serialize messages to the Anoncoin network format as defined in
 * <a href="https://en.anoncoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.anoncoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class AnoncoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(AnoncoinSerializer.class);
    ...
    /**
     * Constructs a AnoncoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public AnoncoinSerializer(NetworkParameters params) {
     ...
     */
    public AnoncoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("AnoncoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.anoncoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Anoncoin protocol message has the following format.
        //
        ...
        AnoncoinPacketHeader header = new AnoncoinPacketHeader(in);
     ...
     */
    public AnoncoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new AnoncoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link AnoncoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(AnoncoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class AnoncoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public AnoncoinPacketHeader(InputStream in) throws ProtocolException, IOException {
