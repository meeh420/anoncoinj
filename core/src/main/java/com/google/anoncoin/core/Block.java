...
import static com.google.anoncoin.core.Utils.doubleDigest;
import static com.google.anoncoin.core.Utils.scryptDigest;
import static com.google.anoncoin.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Anoncoin system.
 ...
 * <a href="http://www.anoncoin.org/anoncoin.pdf">the Anoncoin technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Anoncoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Anoncoin wire format. */
    ...
    /**
     * Contruct a block object from the Anoncoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Anoncoin would be created by the block at the given height.
     * The inflation of Anoncoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.anoncoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    public BigInteger getBlockInflation(int height) {
    	...
    	if (height < 42000) {
    		return Utils.toNanoCoins(4, 2);
    	} else if (height < 77777) {
    		return Utils.toNanoCoins(7, 0);
    	} else if (height < 177777) {
    		return Utils.toNanoCoins(17, 42);
    	} else {
    		return Utils.toNanoCoins(20, 0);
    	}
    }
    ...
    @Override
    protected void anoncoinSerializeToStream(OutputStream stream) throws IOException {
        writeHeader(stream);
    ...
    /** Returns the version of the block data structure as defined by the Anoncoin protocol. */
     ...
     * {@link com.google.anoncoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Anoncoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.anoncoinSerialize().length;
