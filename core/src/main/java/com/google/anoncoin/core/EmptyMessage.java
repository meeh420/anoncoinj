 ...
 * Currently this includes getaddr, ping, verack as well as the special anoncoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void anoncoinSerializeToStream(OutputStream stream) throws IOException {
    }
