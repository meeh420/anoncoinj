...
import com.google.anoncoin.core.Peer.PeerHandler;
import com.google.anoncoin.discovery.PeerDiscovery;
import com.google.anoncoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the anoncoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.anoncoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.anoncoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.anoncoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.anoncoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Anoncoin
     ...
     * times are available via {@link com.google.anoncoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.anoncoin.core.Peer#ping()}.
     */
