...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Anoncoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private AnoncoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new AnoncoinSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // anoncoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Anoncoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Anoncoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Anoncoin serialization for this connection. */
