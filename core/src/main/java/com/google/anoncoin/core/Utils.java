...
/**
 * A collection of various utility methods that are helpful for working with the Anoncoin protocol.
 * To enable debug logging from the library, run with -Danoncoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /**
     * How many "nanocoins" there are in a Anoncoin.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Anoncoin.
    ...
    /**
     * How many "nanocoins" there are in 0.01 Anoncoins.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Anoncoin.
     * The term nanocoin is very misleading, though, because there are only 100 million
     * of them in a coin (whereas one would expect 1 billion).
     ...
     * standard procedure in Anoncoin. The resulting hash is in big endian form.
     */
     ...
     */
    public static String anoncoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String anoncoinValueToPlainString(BigInteger value) {
        if (value == null) {
     ...
     *
     * <tt><p>[24] "Anoncoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
