...
public class VersionMessage extends Message {
    ...
    @Override
    public void anoncoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.anoncoinSerialize(buf);
            // Their address.
            theirAddr.anoncoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for AnoncoinJ
     * users might look like "/AnoncoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/AnoncoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.anoncoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
