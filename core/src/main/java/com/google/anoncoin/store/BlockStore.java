...
import com.google.anoncoin.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Anoncoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.anoncoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.anoncoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
