...
import com.google.anoncoin.core.Transaction.SigHash;
...
import com.google.anoncoin.store.BlockStore;
import com.google.anoncoin.store.MemoryBlockStore;
import com.google.anoncoin.utils.BriefLogFormatter;
import com.google.common.collect.Lists;
import com.google.protobuf.ByteString;

import org.anoncoinj.wallet.Protos;
import org.anoncoinj.wallet.Protos.ScryptParameters;
...
import static com.google.anoncoin.core.TestUtils.*;
import static com.google.anoncoin.core.TestUtils.createFakeBlock;
import static com.google.anoncoin.core.TestUtils.createFakeTx;
import static com.google.anoncoin.core.Utils.anoncoinValueToFriendlyString;
import static com.google.anoncoin.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Anoncoin protocol makes it
    ...
    public void blockChainCatchup() throws Exception {
        ...
        assertEquals(anoncoinValueToFriendlyString(wallet.getBalance()), "0.90");
        assertEquals(null, txn[0]);
        assertEquals(2, confTxns.size());
        assertEquals(txn[1].getHash(), send1.getHash());
        assertEquals(anoncoinValueToFriendlyString(bigints[2]), "1.00");
        assertEquals(anoncoinValueToFriendlyString(bigints[3]), "0.90");
        ...
        assertEquals(anoncoinValueToFriendlyString(wallet.getBalance()), "0.80");
    ...
    public void balances() throws Exception {
        ...
        Transaction send1 = wallet.createSend(new ECKey().toAddress(params), toNanoCoins(0, 10));
        // Reserialize.
        Transaction send2 = new Transaction(params, send1.anoncoinSerialize());
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction txClone = new Transaction(params, tx.anoncoinSerialize());
        try {
    ...
    public void doubleSpendUnspendsOtherInputs() throws Exception {
        ...
        send2 = new Transaction(params, send2.anoncoinSerialize());
    ...
    public void pending1() throws Exception {
        ...
        final Transaction t1Copy = new Transaction(params, t1.anoncoinSerialize());
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("anoncoinj-unit-test", null);
