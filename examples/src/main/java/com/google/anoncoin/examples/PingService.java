...
package com.google.anoncoin.examples;

import com.google.anoncoin.core.*;
import com.google.anoncoin.crypto.KeyCrypterException;
import com.google.anoncoin.discovery.DnsDiscovery;
import com.google.anoncoin.discovery.IrcDiscovery;
import com.google.anoncoin.store.BlockStore;
import com.google.anoncoin.store.SPVBlockStore;
 ...
 * <li>Start your anoncoin client in test mode <code>anoncoin -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freeanoncoins.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your anoncoin client to the address provided in the PingService console</li>
 ...
 * .net/projects/anoncoin/files/Anoncoin/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        if (testNet) {
            peerGroup.addPeerDiscovery(new IrcDiscovery("#anoncoinTEST3"));
        } else {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.anoncoinValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        // It's impossible to pick one specific identity that you receive coins from in Anoncoin as there
        ...
        try {
            ...
            System.out.println("Received " + Utils.anoncoinValueToFriendlyString(value) + " from " + from.toString());
